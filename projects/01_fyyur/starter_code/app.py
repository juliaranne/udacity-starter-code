...
def create_artist_submission():
  ...
  try:
    ...
    new_venue = Venue(name=name, city=city, state=state, phone=phone, genres=genre_objects, image_link=image_link, facebook_link=facebook_link, website_link=website_link, seeking_venue=seeking_venue, seeking_description=seeking_description)
    db.session.add(new_venue)
    db.session.commit()
...
def create_show_submission():
  ...
  try:
    ...
    flash('There was an error and this show could not be listed')
  finally:
    db.session.close()
